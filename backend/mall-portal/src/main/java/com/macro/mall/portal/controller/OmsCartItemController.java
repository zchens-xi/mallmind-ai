...
//        if (count > 0) {
//            // 添加触发点：更新短期动量，购物车行为点击强度设为1.8（强于收藏）
//            try {
//                // 获取商品详情
//                PmsProduct product = productService.getProductById(cartItem.getProductId());
//                if (product != null) {
//                    ProductInfo productInfo = convertToProductInfo(product);
//                    // 更新短期动量
//                    pushService.renewShortTermMomentum(cartItem.getMemberId(), productInfo, 1.8);
//                    // 同时更新推送动量
//                    pushService.renewPushMomentum(cartItem.getMemberId(), productInfo, 1.8);
//                }
//            } catch (Exception e) {
//                // 记录异常但不影响正常返回
//                System.err.println("更新用户购物车动量失败: " + e.getMessage());
//            }
//
