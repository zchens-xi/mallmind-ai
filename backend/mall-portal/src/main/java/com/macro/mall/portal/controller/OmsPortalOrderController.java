...
//        Map<String, Object> result = portalOrderService.generateOrder(orderParam);
//
//        // 添加触发点：更新短期动量，下单行为点击强度设为2.0（最强）
//        try {
//            UmsMember currentMember = memberService.getCurrentMember();
//            if (currentMember != null && result.containsKey("order") && result.get("order") != null) {
//                // 获取订单中的商品信息
//                List<Long> productIds = portalOrderService.getOrderProductIds(orderParam);
//                if (productIds != null && !productIds.isEmpty()) {
//                    for (Long productId : productIds) {
//                        PmsProduct product = productService.getProductById(productId);
//                        if (product != null) {
//                            ProductInfo productInfo = convertToProductInfo(product);
//                            // 更新短期动量
//                            pushService.renewShortTermMomentum(currentMember.getId(), productInfo, 2.0);
//                            // 同时更新推送动量
//                            pushService.renewPushMomentum(currentMember.getId(), productInfo, 2.0);
//                        }
//                    }
//                }
//            }
//        } catch (Exception e) {
//            // 记录异常但不影响正常返回
//            System.err.println("更新用户订单动量失败: " + e.getMessage());
//        }
//
//        return CommonResult.success(result, "下单成功");
//    }
